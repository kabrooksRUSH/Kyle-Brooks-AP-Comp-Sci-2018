...
public class AppEntry extends Activity {
    ...
    private static final String RESOURCE_CLASS = "air.com.midjiwan.polytopia.R";
    ...
    class C00023 implements ServiceConnection {
        C00023() {
        }
    ...
    private void BroadcastIntent(String action, String data) {
        try {
            startActivity(Intent.parseUri(data, 0).setAction(action).addFlags(DriveFile.MODE_READ_ONLY));
    ...
    private void showDialog(int titleId, String text, int positiveButtonId, int negativeButtonId) {
        ...
        alertDialogBuilder.setOnCancelListener(new C00012());
    ...
    private void launchAIRService() {
        try {
            ...
            bindService(intent, new C00023(), 1);
        } catch (Exception e) {
        }
    }

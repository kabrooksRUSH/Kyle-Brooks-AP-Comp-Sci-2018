...
public class InFilter<T> extends AbstractFilter {
    ...
    public T getValue() {
        return ((Collection) this.zzanW.zza(this.zzaoj)).iterator().next();
    }
    ...
    public <F> F zza(zzf<F> com_google_android_gms_drive_query_internal_zzf_F) {
        return com_google_android_gms_drive_query_internal_zzf_F.zzb(this.zzaoj, getValue());
    }
}

...
public class CustomPropertyKey implements SafeParcelable {
    ...
    CustomPropertyKey(int versionCode, String key, int visibility) {
        ...
        zzx.zzb(zzamz.matcher(key).matches(), (Object) "key name characters must be alphanumeric or one of .!@$%^&*()-_/");
    ...
    public boolean equals(Object obj) {
        ...
        if (!(customPropertyKey.getKey().equals(this.zzue) && customPropertyKey.getVisibility() == this.mVisibility)) {
            z = false;
        }
        return z;
    }

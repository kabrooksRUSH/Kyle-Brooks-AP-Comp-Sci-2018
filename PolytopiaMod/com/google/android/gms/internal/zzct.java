...
public class zzct extends NativeContentAd {
    private final List<Image> zzxe = new ArrayList();
    ...
    public zzct(zzcs com_google_android_gms_internal_zzcs) {
        ...
        try {
            for (Object zzd : this.zzxg.getImages()) {
                zzcm zzd2 = zzd(zzd);
                if (zzd2 != null) {
        ...
        try {
            zzcm zzdA = this.zzxg.zzdA();
            if (zzdA != null) {
                com_google_android_gms_internal_zzcn = new zzcn(zzdA);

...
public class zzfb extends zzfh {
    ...
    class C06181 implements OnClickListener {
        ...
        C06181(zzfb com_google_android_gms_internal_zzfb) {
    ...
    class C06192 implements OnClickListener {
        final /* synthetic */ zzfb zzAa;

        C06192(zzfb com_google_android_gms_internal_zzfb) {
            this.zzAa = com_google_android_gms_internal_zzfb;
        }
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzK.setTitle(zzp.zzby().zzd(C0094R.string.create_calendar_title, "Create calendar event"));
            zzK.setMessage(zzp.zzby().zzd(C0094R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzK.setPositiveButton(zzp.zzby().zzd(C0094R.string.accept, "Accept"), new C06181(this));
            zzK.setNegativeButton(zzp.zzby().zzd(C0094R.string.decline, "Decline"), new C06192(this));
            zzK.create().show();
        } else {

...
public final class zzgu {
        ...
        try {
            ...
            if (adResponseParcel != null) {
                ...
                if (adResponseParcel.zzEJ > 0) {
                    ...
                    return new AdResponseParcel(adRequestInfoParcel, optString2, str2, list, list2, j, jSONObject.optBoolean("mediation", false), jSONObject.optLong("mediation_config_cache_time_milliseconds", -1), list3, jSONObject.optLong("refresh_interval_milliseconds", -1), i2, optString4, j2, optString6, optBoolean, str3, optString, jSONObject.optBoolean("custom_render_allowed", false), z, adRequestInfoParcel.zzEv, jSONObject.optBoolean("content_url_opted_out", true), jSONObject.optBoolean("prefetch", false), jSONObject.optInt("oauth2_token_status", 0), jSONObject.optString("gws_query_id", ""), "height".equals(jSONObject.optString("fluid", "")));
                }
            }
            j = j3;
            optString = jSONObject.optString("active_view");
    ...
    public static JSONObject zza(Context context, AdRequestInfoParcel adRequestInfoParcel, zzgy com_google_android_gms_internal_zzgy, zza com_google_android_gms_internal_zzhb_zza, Location location, zzbr com_google_android_gms_internal_zzbr, String str, String str2, List<String> list) {
        try {
            ...
            if (zzb.zzN(2)) {
                zzb.m12v("Ad Request JSON: " + zzp.zzbv().zzz(hashMap).toString(2));
            }

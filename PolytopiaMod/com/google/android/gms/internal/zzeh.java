...
public final class zzeh implements zza {
    ...
    public zzei zza(long j, long j2) {
        ...
        synchronized (this.zzpd) {
            long elapsedRealtime = SystemClock.elapsedRealtime();
            final zzeg com_google_android_gms_internal_zzeg = new zzeg();
            zzid.zzIE.post(new Runnable(this) {
                ...
                public void run() {
                    synchronized (this.zzzs.zzpd) {
                        ...
                        com_google_android_gms_internal_zzeg.zza(this.zzzs);
                        this.zzzs.zza(com_google_android_gms_internal_zzeg);
                    }
                }
            });

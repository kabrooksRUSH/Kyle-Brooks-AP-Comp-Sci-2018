...
public class zzif {
    ...
    class C06632 implements OnClickListener {
        ...
        C06632(zzif com_google_android_gms_internal_zzif) {
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            final Object zzaD = zzaD(this.zzII);
            ...
            builder.setPositiveButton("Share", new OnClickListener(this) {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    zzp.zzbv().zzb(this.zzIN.mContext, Intent.createChooser(new Intent("android.intent.action.SEND").setType("text/plain").putExtra("android.intent.extra.TEXT", zzaD), "Share via"));
                }
            });
            builder.setNegativeButton("Close", new C06632(this));
            builder.create().show();
            return;
        }

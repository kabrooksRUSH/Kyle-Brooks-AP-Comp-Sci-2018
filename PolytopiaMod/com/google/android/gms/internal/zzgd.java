...
public class zzgd implements Runnable {
    ...
    public void zza(AdResponseParcel adResponseParcel, zzji com_google_android_gms_internal_zzji) {
        ...
        this.zzoM.loadDataWithBaseURL(TextUtils.isEmpty(adResponseParcel.zzBF) ? null : zzp.zzbv().zzaz(adResponseParcel.zzBF), adResponseParcel.body, "text/html", "UTF-8", null);
    }

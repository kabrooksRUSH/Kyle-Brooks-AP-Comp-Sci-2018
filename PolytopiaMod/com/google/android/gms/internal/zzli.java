...
public final class zzli extends GoogleApiClient {
    ...
    private final zze zzaco = new C06901(this);
    private final ConnectionCallbacks zzacp = new C06912(this);
    private final com.google.android.gms.common.internal.zzk.zza zzacq = new C06923(this);
    ...
    class C06901 implements zze {
        final /* synthetic */ zzli zzacr;

        C06901(zzli com_google_android_gms_internal_zzli) {
    ...
    class C06912 implements ConnectionCallbacks {
        final /* synthetic */ zzli zzacr;

        C06912(zzli com_google_android_gms_internal_zzli) {
            this.zzacr = com_google_android_gms_internal_zzli;
        }
    ...
    class C06923 implements com.google.android.gms.common.internal.zzk.zza {
        final /* synthetic */ zzli zzacr;

        C06923(zzli com_google_android_gms_internal_zzli) {
            this.zzacr = com_google_android_gms_internal_zzli;
        }
    ...
    private OnConnectionFailedListener zza(final Api<?> api, final int i) {
        return new OnConnectionFailedListener(this) {
            ...
            public void onConnectionFailed(ConnectionResult result) {
                this.zzacr.zzabt.lock();
                try {
                    this.zzacr.zzacj.zza(result, api, i);
                } finally {
                    this.zzacr.zzabt.unlock();
                }
            }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzacg.containsKey(zzlx.zzRk)) {
            ...
            ConnectionCallbacks c06945 = new ConnectionCallbacks(this) {
                final /* synthetic */ zzli zzacr;
            ...
            GoogleApiClient build = new Builder(this.mContext).addApi(zzlx.API).addConnectionCallbacks(c06945).addOnConnectionFailedListener(new OnConnectionFailedListener(this) {
                final /* synthetic */ zzli zzacr;
                ...
                new Handler(this.mContext.getMainLooper()).post(new Runnable(this) {
                    ...
                    public void run() {
                        if (!lifecycleActivity.isFinishing() && !lifecycleActivity.getSupportFragmentManager().isDestroyed()) {
                            zzlp.zzb(lifecycleActivity).zzbp(this.zzacr.zzaaM);
                        }
                    }
                });
                return;

...
public final class zzju implements zzk, AppIndexApi {
    ...
    private static abstract class zzb<T extends Result> extends com.google.android.gms.internal.zzlb.zza<T, zzjs> {
        ...
        protected abstract void zza(zzjp com_google_android_gms_internal_zzjp) throws RemoteException;

        protected final void zza(zzjs com_google_android_gms_internal_zzjs) throws RemoteException {
            zza(com_google_android_gms_internal_zzjs.zzlw());
        }
    }
    ...
    private static final class zza implements ActionResult {
        ...
        zza(zzju com_google_android_gms_internal_zzju, PendingResult<Status> pendingResult, Action action) {
            this.zzRf = com_google_android_gms_internal_zzju;
    ...
    private static final class zzd extends zzjr<Status> {
        public zzd(com.google.android.gms.internal.zzlb.zzb<Status> com_google_android_gms_internal_zzlb_zzb_com_google_android_gms_common_api_Status) {
            super(com_google_android_gms_internal_zzlb_zzb_com_google_android_gms_common_api_Status);
        }
    ...
    private PendingResult<Status> zza(GoogleApiClient googleApiClient, Action action, int i) {
        ...
        return zza(googleApiClient, zzjt.zza(action, System.currentTimeMillis(), packageName, i));
    }
    ...
    public PendingResult<Status> viewEnd(GoogleApiClient apiClient, Activity activity, Intent viewIntent) {
        String packageName = apiClient.getContext().getPackageName();
        return zza(apiClient, new com.google.android.gms.appdatasearch.UsageInfo.zza().zza(UsageInfo.zza(packageName, viewIntent)).zzw(System.currentTimeMillis()).zzan(0).zzao(2).zzlv());
    }
    ...
    public PendingResult<Status> zza(GoogleApiClient googleApiClient, final UsageInfo... usageInfoArr) {
        ...
        return googleApiClient.zza(new zzc<Status>(this, googleApiClient) {
            final /* synthetic */ zzju zzRe;

            protected void zza(zzjp com_google_android_gms_internal_zzjp) throws RemoteException {
                com_google_android_gms_internal_zzjp.zza(new zzd(this), packageName, usageInfoArr);
            }
        });
    }
}

...
public final class InvitationRef extends zzc implements Invitation {
    ...
    InvitationRef(DataHolder holder, int dataRow, int numChildren) {
        ...
        this.zzaAC = new ArrayList(numChildren);
        String string = getString("external_inviter_id");
        Object obj = null;
        for (int i = 0; i < numChildren; i++) {
            ParticipantRef participantRef = new ParticipantRef(this.zzabq, this.zzadl + i);
            if (participantRef.getParticipantId().equals(string)) {
                obj = participantRef;
            }
            this.zzaAC.add(participantRef);
        }
        this.zzaAF = (ParticipantRef) zzx.zzb(obj, (Object) "Must have a valid inviter!");
    }

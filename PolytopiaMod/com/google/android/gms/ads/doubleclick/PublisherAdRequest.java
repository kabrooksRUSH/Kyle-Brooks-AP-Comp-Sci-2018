...
public final class PublisherAdRequest {
    ...
    public static final class Builder {
        ...
        public Builder setContentUrl(String contentUrl) {
            ...
            zzx.zzb(contentUrl.length() <= AdRequest.MAX_CONTENT_URL_LENGTH, "Content URL must not exceed %d in length.  Provided length was %d.", Integer.valueOf(AdRequest.MAX_CONTENT_URL_LENGTH), Integer.valueOf(contentUrl.length()));

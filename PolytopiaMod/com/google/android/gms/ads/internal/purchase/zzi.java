...
public class zzi {
    ...
    public void zzx(final Context context) {
        ServiceConnection c01151 = new ServiceConnection(this) {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                int zza = com_google_android_gms_ads_internal_purchase_zzb.zza(3, context.getPackageName(), IabHelper.ITEM_TYPE_INAPP);
                zzhu zzby = zzp.zzby();
                if (zza == 0) {
                    z = true;
                }
        ...
        context.bindService(intent, c01151, 1);
    }
}

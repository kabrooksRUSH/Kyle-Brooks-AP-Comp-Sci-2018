...
public class zzh {
    ...
    class C00991 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C00991(zzh com_google_android_gms_ads_internal_formats_zzh) {
        ...
        public void zza(zziz com_google_android_gms_internal_zziz, final Map<String, String> map) {
            ...
            if (TextUtils.isEmpty(str2)) {
                this.zzwO.zzoM.loadData(str, "text/html", "UTF-8");
            } else {
                this.zzwO.zzoM.loadDataWithBaseURL(str2, str, "text/html", "UTF-8", null);
            }
        }
    }

    class C01002 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01002(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01013 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01013(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01024 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01024(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01035 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01035(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    public zziz zzdC() {
        ...
        this.zzwJ.zza("/loadHtml", new C00991(this));
        this.zzwJ.zza("/showOverlay", new C01002(this));
        this.zzwJ.zza("/hideOverlay", new C01013(this));
        this.zzoM.zzhe().zza("/hideOverlay", new C01024(this));
        this.zzoM.zzhe().zza("/sendMessageToSdk", new C01035(this));
        return this.zzoM;
    }

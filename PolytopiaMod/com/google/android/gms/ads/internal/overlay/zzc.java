...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C01051 implements Runnable {
        ...
        C01051(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C01062 implements Runnable {
        ...
        C01062(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01084 implements Runnable {
        ...
        C01084(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01095 implements Runnable {
        ...
        C01095(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01106 implements Runnable {
        ...
        C01106(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01117 implements Runnable {
        ...
        C01117(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    static {
        zzAO.put(Integer.valueOf(IabHelper.IABHELPER_SEND_INTENT_FAILED), "MEDIA_ERROR_IO");
        zzAO.put(Integer.valueOf(IabHelper.IABHELPER_MISSING_TOKEN), "MEDIA_ERROR_MALFORMED");
        zzAO.put(Integer.valueOf(IabHelper.IABHELPER_INVALID_CONSUMPTION), "MEDIA_ERROR_UNSUPPORTED");
    ...
    private void zzeA() {
        zzb.m12v("AdMediaPlayerView audio focus lost");
        this.zzBb = false;
        zzeB();
    }
    ...
    private void zzes() {
        Throwable e;
        zzb.m12v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzet() {
        if (zzew() && this.zzAS.getCurrentPosition() > 0 && this.zzAR != 3) {
            zzb.m12v("AdMediaPlayerView nudging MediaPlayer");
            zzb(0.0f);
            this.zzAS.start();
    ...
    private void zzev() {
        zzb.m12v("AdMediaPlayerView abandon audio focus");
        AudioManager zzeC = zzeC();
        if (zzeC != null && this.zzBb) {
    ...
    private void zzez() {
        zzb.m12v("AdMediaPlayerView audio focus gained");
        this.zzBb = true;
        zzeB();
    }
    ...
    private void zzt(boolean z) {
        zzb.m12v("AdMediaPlayerView release");
        if (this.zzAS != null) {
            this.zzAS.reset();
            this.zzAS.release();
            this.zzAS = null;
    ...
    public void onCompletion(MediaPlayer mp) {
        zzb.m12v("AdMediaPlayerView completion");
        zzt(5);
        zzu(5);
        zzid.zzIE.post(new C01062(this));
    }
    ...
    public boolean onInfo(MediaPlayer mp, int what, int extra) {
        ...
        zzb.m12v("AdMediaPlayerView MediaPlayer info: " + ((String) zzAO.get(Integer.valueOf(what))) + ":" + str);
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzb.m12v("AdMediaPlayerView prepared");
        zzt(2);
        this.zzAP.zzeR();
        zzid.zzIE.post(new C01051(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        zzb.m12v("AdMediaPlayerView surface created");
        zzes();
        zzid.zzIE.post(new C01084(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        zzb.m12v("AdMediaPlayerView surface destroyed");
        if (this.zzAS != null && this.zzBc == 0) {
            this.zzBc = this.zzAS.getCurrentPosition();
        }
        zzid.zzIE.post(new C01095(this));
        zzt(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int w, int h) {
        Object obj = 1;
        zzb.m12v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        zzb.m12v("AdMediaPlayerView size changed: " + width + " x " + height);
    ...
    public void pause() {
        zzb.m12v("AdMediaPlayerView pause");
        if (zzew() && this.zzAS.isPlaying()) {
            this.zzAS.pause();
            zzt(4);
            zzid.zzIE.post(new C01117(this));
        }
        zzu(4);
    }

    public void play() {
        zzb.m12v("AdMediaPlayerView play");
        if (zzew()) {
            this.zzAS.start();
            zzt(3);
            zzid.zzIE.post(new C01106(this));
        }
        zzu(3);
    }

    public void seekTo(int millis) {
        zzb.m12v("AdMediaPlayerView seek " + millis);
        if (zzew()) {
    ...
    public void stop() {
        zzb.m12v("AdMediaPlayerView stop");
        if (this.zzAS != null) {
            this.zzAS.stop();
            this.zzAS.release();
            this.zzAS = null;

...
public class zzb {
    ...
    private boolean zzc(Context context, Intent intent) {
        ...
        return (component == null || (zzd.zzaeK && "com.google.android.gms".equals(component.getPackageName()))) ? false : zzmm.zzl(context, component.getPackageName());
    }

...
public final class zzab extends Button {
    ...
    private void zzb(Resources resources, int i, int i2) {
        ...
        switch (i) {
            case 0:
            case 1:
                zzd = zzd(i2, C0094R.drawable.common_signin_btn_text_dark, C0094R.drawable.common_signin_btn_text_light);
                break;
            case 2:
                zzd = zzd(i2, C0094R.drawable.common_signin_btn_icon_dark, C0094R.drawable.common_signin_btn_icon_light);
                break;
            default:
    ...
    private void zzc(Resources resources, int i, int i2) {
        setTextColor(resources.getColorStateList(zzd(i2, C0094R.color.common_signin_btn_text_dark, C0094R.color.common_signin_btn_text_light)));
        switch (i) {
            case 0:
                setText(resources.getString(C0094R.string.common_signin_button_text));
                return;
            case 1:
                setText(resources.getString(C0094R.string.common_signin_button_text_long));
                return;
            case 2:
                setText(null);
                return;
